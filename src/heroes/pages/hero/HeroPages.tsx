                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-red-600 mb-2">{(hero?.strength ?? 0)}</div>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-purple-600 mb-2">{(hero?.intelligence ?? 0)}</div>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-yellow-600 mb-2">{(hero?.speed ?? 0)}</div>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-green-600 mb-2">{(hero?.durability ?? 0)}</div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={(hero?.strength ?? 0) * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{(hero?.strength ?? 0)}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Inteligencia</div>
                                        <div className="flex-1">
                                            <Progress value={(hero?.intelligence ?? 0) * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{(hero?.intelligence ?? 0)}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Velocidad</div>
                                        <div className="flex-1">
                                            <Progress value={(hero?.speed ?? 0) * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{(hero?.speed ?? 0)}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Resistencia</div>
                                        <div className="flex-1">
                                            <Progress value={(hero?.durability ?? 0) * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{(hero?.durability ?? 0)}/10</div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
